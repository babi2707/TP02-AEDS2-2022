...
class Filme {
    ...
    public String print() {
        ...
        return getNome() + getTitulo_Original() + " " + sdf.format(getData_de_Lancamento()) + " " + getDuracao()
                + " " + getGenero()
                + " " + getIdioma_Original() + " " + getSituacao() + " " + getOrcamento() + " " + getKey_Words();
    }
...
public class Movies {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // ------------- for loop para chamar a função que imprime a resposta
        // --------------
        for (int j = 0; j < qtd; j++) {
            MyIO.println(entradas[j].print());
        }
        // ---------------------------------------------------------------------------------
