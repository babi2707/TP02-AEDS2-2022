 ...
 * Matricula: 748190
 * TP02 - Questão 3 - Pesquisa Sequencial em Java
 * 
****************************************/
...
public class Sequencial {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String guardar[] = new String[10000];
        int qtd = 0, qtd2 = 0;
        // ----------------------------------------
        ...
        do {
            s2[qtd2] = MyIO.readLine();
        } while (isFim(s2[qtd2++]) == false);

        // ------------------------------------------------------------------------------------------------------

        qtd2--; // diminuir a quantidade de elementos da string em cada linha lida

        // ---------------- for loop para transformar o contador da string de 32 até 54 para de 0 até 22
        // -----------------

        for (int i = 0; i < (qtd2 - qtd - 2); i++) {
        ...
        // ---------------- for loop para fazer a pesquisa e imprimir a resposta
        // -----------------
        for (int i = 0; i < (qtd2 - qtd - 2); i++) {
            ...
            for (int j = 0; j < qtd; j++) {
                guardar[j] = entradas[j].getNome();

                int cmp = aux[i].compareTo(guardar[j]);
        ...
        // ---------- abrir, escrever e fechar o arquivo log ----------

        Arq.openWrite("748190_sequencial.txt");
        Arq.println("748190\t " + (System.currentTimeMillis() - tempo) + " ms\t" + cont);
        Arq.close();
